...
import { AdvancedWebanyPrinterService } from '../../services/webUSBPrinter';
...
export const AdvancedThermalPrinter: React.FC<ThermalPrinterProps> = ({
  ...
  // Services
  const webUSBService = useRef<AdvancedWebanyPrinterService | null>(null);
  ...
  useEffect(() => {
    ...
    if (enableWebUSB) {
      webUSBService.current = new AdvancedWebanyPrinterService();
